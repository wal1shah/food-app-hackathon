...
const Signup = () => {
  return (
    <div className="md:1920px">
      <Heroimg title="Signup Here" subtitle="Signup" />
      <div className="md:max-w-[424px] w-full h-[724px] shadow-lg shadow-[rgba(255,159,13,0.3)]  mx-auto my-[40px]">
        <h2 className="font-bold text-[20px] pl-[38px] pt-[18px]">Sign Up</h2>
        <div className="flex items-center gap-4 p-4 mx-5 border-[2px] mt-8 rounded-md ">
          <AiOutlineUser size={24} className="opacity-70" />
          <input
            type="text"
            placeholder="Name"
